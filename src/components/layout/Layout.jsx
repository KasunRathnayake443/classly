      ...
      <nav className="p-2 flex-1 overflow-y-auto">
        ...
        <div className="mt-4 mb-1">
          <div className="flex items-center justify-between px-3 mb-1.5">
            <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Classes</span>
            <button onClick={onCreateSpace}
              className="w-5 h-5 rounded-md hover:bg-gray-100 flex items-center justify-center text-gray-400 hover:text-brand-500 transition-colors" title="New class">
